...
public class USMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(USMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new USMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static USMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static USMDateTimeConverter dateTimeConverter = new USMStandardDateTimeConverter();

    public USMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public USMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new USMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=USMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,USMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=USMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
