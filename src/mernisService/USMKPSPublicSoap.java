...
public class USMKPSPublicSoap
{
    ...
    public USMKPSPublicSoap(){}

    public USMKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public USMKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        USMExtendedSoapSerializationEnvelope envelope= new USMExtendedSoapSerializationEnvelope(USMExtendedSoapSerializationEnvelope.VER11);
